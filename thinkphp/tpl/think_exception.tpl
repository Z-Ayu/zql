...
<head>
    <meta charset="UTF-8">
    <title>Sorry，there is some error with this page！</title>
...
<body>
    ...
    <div class="exception">
            ...
            <div class="info" style="max-width:600px;margin:auto;padding:20px;">
              <div class="alert alert-danger" role="alert">
                <h2><?php echo htmlentities($message); ?></h2>
                <h3>很抱歉，你访问的页面发生错误！</h3>
              </div>
              <p>页面<b id="wait">3</b>秒后自动<a id="href" href="<?php $request = Request::instance();echo $request->domain();?>">跳转</a>到竹签录首页！</p>
            </div>
